...
export default function TransactionsPage() {
  ...
  if (error) return <p className='flex justify-center align-middle'>Error al cargar movimientos</p>;

  // Ejemplo de cálculo de total
  const total = data.transactions.reduce((acc: number, tx: any) => acc + tx.amount, 0);
  ...
  return (
    <Layout>
      ...
      <div className="p-6">
        {/* Título del sistema */}
        <h2 className="text-2xl font-bold mb-2">Sistema de gestión de Ingresos y Gastos</h2>
